...
extern UINT StdComponent_report_all_properties(STD_COMPONENT *handle,UCHAR *component_name_ptr, UINT component_name_len,
                                                 NX_AZURE_IOT_PNP_CLIENT *iotpnp_client_ptr);

extern UINT StdComponent_telemetry_send(STD_COMPONENT *handle, NX_AZURE_IOT_PNP_CLIENT *iotpnp_client_ptr);
