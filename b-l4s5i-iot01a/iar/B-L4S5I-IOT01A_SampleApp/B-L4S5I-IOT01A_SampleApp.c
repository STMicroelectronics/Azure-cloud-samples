...
#define MODULE_ID    ""
#define SAMPLE_PNP_MODEL_ID       "dtmi:stmicroelectronics:b_l4s5i_iot01a:standard_fw;1"
...
UINT last_component_len = 0;
  ...
  AZURE_PRINTF("-->sample_desired_properties_parse\r\n");
    ...
    if(sample_StdComp.ReceivedDesiredAccFS==0) {
      sample_send_target_StdComponent_acc_fullscale_report(&sample_StdComp, pnp_client_ptr, sample_StdComp.currentAccFS, 200, 1, "success");
      sample_StdComp.ReceivedDesiredAccFS=1;
    }
    
    if(sample_StdComp.ReceivedDesiredMagFS==0) {
      sample_send_target_StdComponent_mag_fullscale_report(&sample_StdComp, pnp_client_ptr, sample_StdComp.currentMagFS, 200, 1, "success");
      sample_StdComp.ReceivedDesiredMagFS=1;
    }
    
    if(sample_StdComp.ReceivedDesiredGyroFS==0) {
      sample_send_target_StdComponent_gyro_fullscale_report(&sample_StdComp, pnp_client_ptr, sample_StdComp.currentGyroFS, 200, 1, "success");
      sample_StdComp.ReceivedDesiredGyroFS=1;
    }
}
